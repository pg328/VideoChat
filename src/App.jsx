...
const firebaseConfig = {
  apiKey: "AIzaSyAKEml-6z3dTZ4dK-A7m96WBgzyDX53Y1o",
  authDomain: "videochatapp-56650.firebaseapp.com",
  projectId: "videochatapp-56650",
  storageBucket: "videochatapp-56650.appspot.com",
  messagingSenderId: "401721283491",
  appId: "1:401721283491:web:3d08a7c3653abdda0b8016",
};
...
const App = () => {
  ...
  useEffect(async () => {
    ...
    return () => {
      ...
      offerCandidates.delete();
      answerCandidates.delete();
      callDoc.delete();
    };
  }, []);
  ...
  const call = async () => {
        ...
        setMessages((m) => {
          return [
            ...m,
            {
              yours: false,
              content: e.data,
              message_id: m.length ? m[m.length - 1] : 0,
            },
          ];
        });
      };
    ...
    !callDoc.id &&
      alert(
        "Please call Phil! This is a bug that's hard to reproduce! \n Number is 07484188198! Thanks - Phil",
      );
          ...
          <Stack anchor="bottom" fill>
                  ...
                  <Box margin={{ bottom: "xlarge" }}>
                    <Stack anchor="right">
                      <Box background={theme.darkAccent}>
                        <Keyboard
                          onEnter={() => {
                            id ? sendMessage(id) : sendMessage(callId);
                          }}
                        >
                          <TextInput
            ...
            >
              <ScreenSharingContext.Provider
                value={{ isSharing, setIsSharing, remoteVideo }}
              >
                <ButtonBar
                  {...{
                    remoteStream,
